        ...
        <div className="my-5">
          <div>
            ...
            <div className="mt-2">
              <input
                type="text"
                className="w-full rounded-md border-0 py-1.5 text-secondary shadow-sm ring-0 ring-inset ring-gray-300 placeholder:text-gray-400 focus:right-0 focus:ring-inset text-sm"
              />
            </div>
          </div>
        </div>
